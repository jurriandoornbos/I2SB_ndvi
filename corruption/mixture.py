...
class MixtureCorruptDatasetTrain(Dataset):
    ...
    def __getitem__(self, index):
        ...
        corrupt_img = y #self.method.mixture(clean_img.unsqueeze(0), rand_idx).squeeze(0)
...
class MixtureCorruptDatasetVal(Dataset):
    ...
    def __getitem__(self, index):
        ...
        corrupt_img = y #self.method.mixture(clean_img.unsqueeze(0), idx, mask_index=idx).squeeze(0)
